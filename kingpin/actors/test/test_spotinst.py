...
class TestSpotinstException(testing.AsyncTestCase):
    def test_no_json_in_body(self):
        ...
        self.assertEqual("Unknown error: 400 Bad Mmmkay", str(exc))
...
class TestSpotinstBase(testing.AsyncTestCase):
    ...
    def test_init_with_debug_disabled(self):
        ...
        self.assertEqual(20, logging.getLogger("tornado_rest_client.api").level)
...
class TestElastiGroup(testing.AsyncTestCase):
    ...
    def test_parse_group_config(self):
        ...
        self.assertEqual(self.actor._config["group"]["name"], "unittest")

    def test_parse_group_config_no_config(self):
        self.actor._options["config"] = None
        self.assertEqual(None, self.actor._parse_group_config())
    ...
    def test_list_groups(self):
        list_of_groups = {
            ...
            "response": {"items": [{"group": {"name": "test"}}]},
        }

        self.actor._client.aws.ec2.list_groups.http_get = mock_tornado(list_of_groups)
        ret = yield self.actor._list_groups()
        self.assertEqual(ret, [{"group": {"name": "test"}}])
    ...
    def test_get_group_too_many_results(self):
        ...
        self.actor._list_groups = mock_tornado([matching_group, matching_group])
    ...
    def test_precache(self):
        ...
        self.assertEqual(self.actor._config["group"]["capacity"]["target"], 128)
    ...
    def test_set_config(self):
        ...
        fake_ret = {"response": {"items": [{"group": "object"}]}}
        mock_client = mock.MagicMock()
        ...
        mock_client.http_put.assert_called_with(group=self.actor._config["group"])
    ...
    def test_wait_until_stable(self):
        ...
        group_status_mock.assert_has_calls([mock.call(), mock.call(), mock.call()])
